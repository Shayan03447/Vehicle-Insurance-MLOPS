...
class DataIngestion:
    def __init__(self, data_ingestion_config:DataIngestionConfig=DataIngestionConfig()):
        """
        :params_data_ingestion_config: configuration for data ingestion
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        logging.info("Entered split_data_as_train_test_method of Data_ingestion class ")
    ...
    def initiate_data_ingestion(self) ->DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Perfoam train test split on the dataset")
